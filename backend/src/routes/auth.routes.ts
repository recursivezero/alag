...
import { register, checkEmail, sendOtp, verifyOtp, login, googleLogin, getUser, createUser, listUsers, forgotPassword, resetPassword, enableUser, disableUser, logout } from '../controllers/auth.controller'
